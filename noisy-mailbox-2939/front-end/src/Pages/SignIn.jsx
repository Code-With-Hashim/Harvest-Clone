import { Box, Center, FormControl, InputGroup, Text, Button, Stack, Divider, Input, InputRightAddon, InputRightElement, useStatStyles, useToast } from '@chakra-ui/react'
...
import { userSignIn } from '../redux/Actions/authenticated.action'
            ...
            <Center>
                <Box mb='10' border='1px solid rgba(250,93,0,100%);' bgColor={'orange.100'} boxSize={'450px'}>
                    <FormControl m='auto' w='85%'>
                        <Button onClick={handleSignIn} my={10} leftIcon={<FaGoogle />} border='1px solid gray' _hover={{ border: '1px solid black' }} bgColor='white' color='black' colorScheme={'black'} w='full'>Sign In with Google</Button>
                        ...
                        <Button isLoading={loading} onClick={handelClick} w='full' colorScheme={'green'}>Sign In</Button>
                    </FormControl>
                </Box>
            </Center>

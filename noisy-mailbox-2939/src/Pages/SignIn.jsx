...
export default function SignIn() {
    ...
    const {setAuth, setToken , token , isAuth} = useContext(AuthContext)
    ...
    const handelClick =()=> {
        getData(userData).then((res)=> setToken(res.data.token),
        setAuth(true)
        )
    }

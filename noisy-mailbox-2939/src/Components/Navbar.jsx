    ...
    return (
        <Box>
            <Flex zIndex={2} bgColor={"white"}position={'fixed'}  top={0}  boxShadow='base' minWidth='max-content' px={20} alignItems='center' gap='10'>
                ...
                <Spacer />
                <ButtonGroup gap='2'>
                    <Button colorScheme={"white"} color="black" variant='ghost'>Sign In</Button>
                    <Button borderRadius={15} px={10} py="3" colorScheme="rgba(250,93,0,100%);">Try Harvest Free</Button>
                </ButtonGroup>
            </Flex>
